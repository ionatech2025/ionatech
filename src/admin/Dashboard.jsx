...
import { Package, FolderKanban, Settings2, Users, Info, Phone } from 'lucide-react'

const CARDS = [
  { to: '/admin/products', label: 'Products', desc: 'Showcase real iONA TECH work — clients, links, tech stack.', icon: Package },
  { to: '/admin/projects', label: 'Projects', desc: 'Ongoing and delivered client projects, linked to their live URLs.', icon: FolderKanban },
